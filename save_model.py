...
Your goal is to generate a new sequence of sets using the same all-caps labels as the ones in the provided context.
Base your sets off the practice title given by the user
"""
